                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-md-12">
                        ...
                        <img src="<?php echo SITE_TEXT_LOGO; ?>" alt="TextLogo" height="100">
                            <?php 
                                echo "<p><br><h3><b>Error 500 Internal Server Error.</b></h3>(Our team has been notified and will fix it soon.)" ; 
                            ...
                            ?>
                            <br><br>
                            <a href="<?php echo BASE_URL . "/../public/shop/index.php"; ?>" class="mt-2 btn btn-primary  <?php echo ($index_locked == 'DisableLogin' ? 'disabled' : ''); ?> ">Shop</a>
                        </div>
                    </div>
                </div>
            </div>
