                    ...
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider"
                                style="background-image: url(<?= SHOP_IMAGES . '/800x500.png' ?>);">
                                <div class="content">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            ...
                            <div class="hero-small-banner"
                                style="background-image: url(<?= SHOP_IMAGES . '/370x250.png' ?>);">
                                <div class="content">
                                    <h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="<?= SHOP_IMAGES . '/180x180.png' ?>" alt="#">
                        </div>
                    </div>
                    <!-- End Single Category -->
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="<?= SHOP_IMAGES . '/335x335.png' ?>" alt="#">
                            <div class="button">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style="background-image:url(<?= SHOP_IMAGES . '/620x340.png' ?>)">
                        <div class="content">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner custom-responsive-margin"
                        style="background-image:url(<?= SHOP_IMAGES . '/620x340.png' ?>)">
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    ...
                    <div class="single-banner right"
                        style="background-image:url(<?= SHOP_IMAGES . '/730x310.png' ?>);margin-top: 30px;">
                        <div class="content">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        <div class="image">
                            <img src="<?= SHOP_IMAGES . '/510x600.png' ?>" alt="#">
                            <span class="sale-tag">-50%</span>
                        </div>
                        <div class="text">
            ...
            <div class="brands-logo-wrapper">
                <div class="brands-logo-carousel d-flex align-items-center justify-content-between">
                    <div class="brand-logo">
                        <img src="<?= SHOP_IMAGES . '/220x160.png' ?>" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="<?= SHOP_IMAGES . '/220x160.png' ?>" alt="#">
                    </div>
