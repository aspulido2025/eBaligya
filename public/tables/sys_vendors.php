    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div>
                                        <table id="vendorsTable" class="table table-hover table-striped border" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="dt-head-right">#</th>            
                                                    <th>Vendor</th>
                                                    <th>Code<br>Business Name</th>
                                                    <th>Area</th>
                                                    <th>Type</th>
                                                    <th>Status</th>
                                                    <th class="dt-head-right">Encoder<br>Registered</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
                                ...
                                <div class="card-footer bg-success d-flex justify-content-between" id="bottom">
                                    ...
                                    <span><?php latest_modification("sys_vendors.php"); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $(function() {
            $('#vendorsTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: 'ajax/ajax_vendors.php',
                type: 'GET',
                dataSrc: 'data',
                deferRender: true,
                autoWidth: false,
                pageLength: 25,
                order: [[6, 'desc']], // order by created DESC
                    ...
                    { data: "created",
                        render: function (data, type, row) {
                            ...
                            if (type === 'display' || type === 'filter') {
                                ...
                                return row.encoder + `<br>` + `<b>${formattedDate}</b><br>
                ...
                columnDefs: [
                    ...
                    { targets: [0,6], className: 'dt-body-right dt-head-right' } 
