        ...
        <div id="main-wrapper">
            ...
            <div class="content-body">
                <div class="container-fluid">
                    <?php 
                        $breadCrumb = "Administration, System Logs, SMS Logs";
                                        ...
                                        <table id="aspTable" class="table table-hover table-striped border" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $sql = "SELECT log_sms.*, system_users.fullname AS sender
                                                            FROM log_sms
                                                            LEFT JOIN system_users ON system_users.id = log_sms.created_id
                                                            WHERE log_sms.created BETWEEN ? AND ? ";
                                                    ...
                                                    foreach ($dataSet as $row) {
                                                        ...
                                                        echo ("<td>".($_SESSION['rbac']['role_id'] > 2 ?
                                                            ...
                                                            mobile_number_format($row['mobile_number'],'showMobile')) . 
                                                            "</td>");
                                                        echo ("<td class='text-info'>".($_SESSION['rbac']['role_id'] > 2 ?
                                                            formatValues(preg_replace('/^[^,]*/', 'Your OTP is ********', $row['sms_string'])) :
                                                            formatValues($row['sms_string'])) .
                                                            "</td>");
                                                        // End Masking

                                                        // Status Code Map
                                                        $desc = $lookup->getDescription("SMS CODES", $row['status_code']);
