        ...
        <div id="main-wrapper">
            ...
            <div class="content-body">
                <div class="container-fluid">
                    <?php 
                        $breadCrumb = "Administration, System Logs, Master Index";
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div>
                                        <table id="logsTable" class="table table-hover table-striped border" cellspacing="0" width="100%">
                                            <thead>
                                ...
                                <!-- <div class="card-footer bg-success" id="bottom">
                                    ...
                                    <span><?php //latest_modification("log_error.php"); ?></span>
                                </div> -->
        ...
        $(function() {
            $('#logsTable').DataTable({
                    ...
                    { data: "created",
                        render: function (data, type, row) {
                            if (type === 'display' || type === 'filter') {
                                ...
                                let optionsDate = { month: 'long', day: '2-digit', year: 'numeric' };
                ...
                columnDefs: [
                    ...
                    { targets: [0,2,5], className: 'dt-body-right dt-head-right' } 
                ...
                drawCallback: function(settings) {
                    ...
                    $('#logsTable').on('xhr.dt', function(e, settings, json) {
                        if (json.debug && json.debug.execution_ms) {
                            $('#execTime').text((json.debug.execution_ms / 1000).toFixed(4) + ' ms');
                        }
                    });
                },
                ...
                initComplete: function () {
                    ...
                    let api = this.api();
                    let tableId = api.table().node().id; // e.g. "logsTable"
                    $(api.table().container())
                        .find('input[type="search"]')
                        .attr('id', tableId + '_search'); // → "logsTable_search"
                }
