        ...
        <div id="main-wrapper">
            ...
            <div class="content-body">
                <div class="container-fluid">
                    <?php 
                        $breadCrumb = "Administration, System Logs, Transaction Logs";
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    $sql = "SELECT 
                                                            ...
                                                            LEFT JOIN system_users ON system_users.id = log_transaction.user_id
                                                            WHERE log_transaction.created BETWEEN ? AND ? ";
                                                    ...
                                                    foreach ($dataSet as $row) {
                                                        ...
                                                        echo ("<td class='text-danger'>".formatValues($row['turnout'])."</td>");
                                                        echo ("<td><small>".formatValues($row['entity'] . " #" . $row['entity_id'])."</small></td>");
                                                        echo ("<td>".formatValues($row['ipaddress'])."</td>");

                                                        echo ("<td><small>".formatValues($row['user_agent'])."</small></td>");
                                                        echo ("<td>".formatValues($row['before_data'])."</td>");
                                                        echo ("<td>".formatValues($row['after_data'])."</td>");
                                                        echo ("<td>".formatValues($row['extra_context'])."</td>");
                    ...
                    // Extra Context preview (col 4)
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            try {
                                ...
                                .replace(/'/g, "&apos;")
                                .replace(/"/g, "&quot;");
                                let colTitle = meta.col == 6 ? "Before Data" : (meta.col == 7 ? "After Data" : "Extra Context");
