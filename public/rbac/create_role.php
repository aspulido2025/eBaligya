    ...
    <div id="main-wrapper">
        ...
        <div class="content-body">
            <div class="container-fluid">
                <?php 
                    $breadCrumb = "Administration, RBAC, Create New Role";
                    ...
                    <div class="col-lg-6 col-xlg-6 col-md-6">
                        <div class="card">
                            <div class="card-header bg-success">
                                <h5 class="text-white"><?= trim(substr($breadCrumb, strrpos($breadCrumb, ',') + 1)) ?></h5> 
                            </div>
                            <div class="card-body">
                                <form method="post" action="sql_create_role.php">
                                    <div class="row">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <textarea name="varDescription" rows="4" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <br><br>
